                ...
                ajax: { // define ajax settings
                    ...
                    dataSrc: function (res) { // Manipulate the data returned from the server
                        if (res.customActionMessage) {
                            Xcms.showNotification(res.customActionMessage, res.customActionStatus);
                        }
                        ...
                        Xcms.unblockUI(_self.$tableContainer);

                        return res.data;
                    },
                    error: function () { // handle general connection errors
                        this.onError.call(undefined, _self);
                        Xcms.showNotification(this.dataTableParams.language.ajaxRequestGeneralError, 'danger');

                        Xcms.unblockUI($tableContainer);
                    }
                },
...
window.Xcms.DataTable = DataTable;